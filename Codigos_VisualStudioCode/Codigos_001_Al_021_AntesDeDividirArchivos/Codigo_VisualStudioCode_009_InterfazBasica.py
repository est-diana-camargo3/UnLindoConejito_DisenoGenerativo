...
def crear_ui():
    ...
    ventana = cmds.window("miVentanaConejo", title="MI DULCE FORTUNA", widthHeight=(300, 500))
    ...
    # 1. TÍTULO Y CRÉDITOS
    # =========================
    cmds.separator(h=8, style="none") #espacio entre el borde de la ventana y el titulo
    cmds.rowLayout(numberOfColumns=1, adjustableColumn=1)
    cmds.text(label="MI DULCE FORTUNA",height=30,bgc=fondorosado,font="boldLabelFont",align="center")
    ...
    # =========================
    # 3. EMOCIONES (VERSIÓN COMPATIBLE)
    # =========================

    cmds.separator(h=10, style="none")

    # Crear colección (solo permite una selección)
    ...
    # 4. BOTONES
    # =========================
    cmds.rowLayout(numberOfColumns=3,columnWidth3=(100, 120, 100)) # izquierda, botón, derecha
    ...
    cmds.rowLayout(numberOfColumns=3,columnWidth3=(110, 120, 100)) # izquierda, botón, derecha
    cmds.text(label="", bgc=fondorosado) # espacio izquierdo
    cmds.button(
        label="Borrar Escena 🧹",
    ...
    cmds.separator(h=20, style="none") #espacio entre el titulo y el menú
    cmds.text(label="Realizado por:", bgc=fondorosado)
