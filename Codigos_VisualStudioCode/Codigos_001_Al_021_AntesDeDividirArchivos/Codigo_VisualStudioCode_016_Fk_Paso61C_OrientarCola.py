...
def orientar_joints_de_toda_la_cadena(ListaDelSistemaFK):
    ...
    #orientar_subcadena_FK(ListaDelSistemaFK["piernaR_FK"], "zdown")
    #orientar_subcadena_FK(ListaDelSistemaFK["piernaL_FK"], "zup")
...
def generar_conejo_ui(*args):
    ...
    orientar_joints_de_toda_la_cadena(ListaDelSistemaFK)
...
#import Codigo_VisualStudioCode_016_Fk_Paso61C_OrientarPiesyCola
#importlib.reload(Codigo_VisualStudioCode_016_Fk_Paso61C_OrientarPiesyCola)
#Codigo_VisualStudioCode_016_Fk_Paso61C_OrientarPiesyCola.crear_ui()
# endregion
