...
"""
    ...
    if morfologia == "vertical":
        ...
        oreja_izq = crear_cubo("Oreja_Izquierda_006",        (m*3,    m*7,   m*2      ),    ((-m*1.5)-10, (((m*10)/3)*2)-m, m         ),  tipo="orejas")
        oreja_der = crear_cubo("Oreja_Derecha_007",          (m*3,    m*7,   m*2      ),    ((-m*1.5)+10, (((m*10)/3)*2)-m, m         ),  tipo="orejas")
        ...
        tronco = crear_cubo("Tronco_Primitiva_010",          (m*13,   m*20,  (m*16)/2 ),    ((-m*6.5),    (-m*9),          (m*8)/2    ),  tipo="tronco") #CAMBIÓ
        ...
        pie_izq = crear_cubo("PieIzquierdo_Primitiva_008",   (m*4,    m*6,   m*4      ),    ((-m*2)-10,   (-m*28.3),       (m*2)      ),  tipo="piernas") #CAMBIÓ
        pie_der = crear_cubo("PieDerecho_Primitiva_009",     (m*4,    m*6,   m*4      ),    ((-m*2)+10,   (-m*28.3),       (m*2)      ),  tipo="piernas") #CAMBIÓ
        cola = crear_cubo("Cola_Primitiva_013",              (m*3,    m*3,   m*3      ),    ((-m*3),      (-m*9)+(-m*12),  (m*1.5)-20 ),  tipo="cola") #CAMBIÓ

    
    elif morfologia == "estandar":
        #                            nombre                            escala                            posicion 
        cabeza = crear_cubo("Cabeza_Primitiva_001",          (m*10,   m*10,         (m*10)/2 ),    (0,     0,                  0          )  ,  tipo="cabeza") 
        ojo_izq = crear_cubo("OjoIzquierdo_Primitiva_002",   (m,      m,            (m*1.7)  ),    (m*7,   (-(m*10)/3.7),      (m*1.7)-m  )  ,  tipo="cabeza")
        ojo_der = crear_cubo("OjoDerecho_Primitiva_003",     (m,      m,            (m*1.7)  ),    (m*2,   (-(m*10)/3.7),      (m*1.7)-m  )  ,  tipo="cabeza")
        nariz = crear_cubo("Nariz_Primitiva_004",            (m,      m,            (m*1.7)  ),    (m*4.5, (-(m*10)/2),        (m*1.7)-m  )  ,  tipo="cabeza")
        boca = crear_cubo("Boca_Primitiva_005",              (m*3,    m/2,          (m*1.7)  ),    (m*3.5, (-(m*10)/1.33),     (m*1.7)-m  ),  tipo="cabeza")
        oreja_izq = crear_cubo("Oreja_Izquierda_006",        (m*3,    ((m*10)/3)*2, m*2      ),    (m*6,   (((m*10)/3)*2)-m,   (-m*1.5)   ),  tipo="cabeza")
        oreja_der = crear_cubo("Oreja_Derecha_007",          (m*3,    ((m*10)/3)*2, m*2      ),    (m,     (((m*10)/3)*2)-m,   (-m*1.5)   ),  tipo="cabeza")

        pie_izq = crear_cubo("PieIzquierdo_Primitiva_008",   (m*3,    m*3,          m*2      ),    (m*6,    (-m*21),              (-m*1.5)),  tipo="cabeza")
        pie_der = crear_cubo("PieDerecho_Primitiva_009",     (m*3,    m*3,          m*2      ),    (m,      (-m*21),              (-m*1.5)),  tipo="cabeza")
        tronco = crear_cubo("Tronco_Primitiva_010",          (m*13,   m*13,         (m*16)/2 ),    (-m*1.5, (-m*9),            (m*1.5)   )  ,  tipo="cabeza")
        mano_izq = crear_cubo("ManoIzquierda_Primitiva_011", (m*4,    m*3,          m*2      ),    (m*10.5, (-m*12),           (-m*1.5)   ),  tipo="cabeza")
        mano_der = crear_cubo("ManoDerecha_Primitiva_012",   (m*4,    m*3,          m*2      ),    (-m*4.5, (-m*12),           (-m*1.5)   ),  tipo="cabeza")
        cola = crear_cubo("Cola_Primitiva_013",              (m,      m,            m*2      ),    (m*4.5,  (-m*9)+(-m*7.2),   (-m*5.5)   ),  tipo="cabeza") #CAMBIÓ
        ...
        pie_izq = crear_cubo("PieIzquierdo_Primitiva_008",   (m*4,    m*3,          m*2      ),    (m*6,    (-m*21),              (-m*1.5)),  tipo="cabeza")
        pie_der = crear_cubo("PieDerecho_Primitiva_009",     (m*4,    m*3,          m*2      ),    (0,      (-m*21),              (-m*1.5)),  tipo="cabeza")
        tronco = crear_cubo("Tronco_Primitiva_010",          (m*19,   m*13,         (m*16)/2 ),    (-m*4.5, (-m*9),            (m*1.5)   )  ,  tipo="cabeza")
        mano_izq = crear_cubo("ManoIzquierda_Primitiva_011", (m*4,    m*3,          m*2      ),    (m*13.5, (-m*12),           (-m*1.5)   ),  tipo="cabeza")
        mano_der = crear_cubo("ManoDerecha_Primitiva_012",   (m*4,    m*3,          m*2      ),    (-m*7.5, (-m*12),           (-m*1.5)   ),  tipo="cabeza")
        cola = crear_cubo("Cola_Primitiva_013",              (m,      m,            m*2      ),    (m*4.5,  (-m*9)+(-m*7.2),   (-m*5.5)   )  ,  tipo="cabeza")
